...
import com.github.ont.cyanowallet.view.jptab.animate.Animatable;
import com.github.ont.cyanowallet.view.jptab.animate.AnimationType;
import com.github.ont.cyanowallet.view.jptab.animate.FlipAnimater;
import com.github.ont.cyanowallet.view.jptab.animate.JumpAnimater;
import com.github.ont.cyanowallet.view.jptab.animate.RotateAnimater;
import com.github.ont.cyanowallet.view.jptab.animate.Scale2Animater;
import com.github.ont.cyanowallet.view.jptab.animate.ScaleAnimater;
...
public class JPTabBar extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    //默认的没有选中的文字和图标的颜色
    private static final int DEFAULT_NORMAL_COLOR = 0x3e3e3e;
    //默认的上下背景间隔
    private static final int DEFAULT_MARGIN = 10;
    //默认的选中颜色
    private static final int DEFAULT_SELECT_COLOR = 0x32a4be;
    //默认是否接受颜色随着字体变化
    private static final boolean DEFAULT_ACEEPTFILTER = true;
    //默认的徽章背景颜色
    private static final int DEFAULT_BADGE_COLOR = 0xffffff;
    //默认的徽章字体大小
    private static final int DEFAULT_BADGE_TEXTSIZE = 10;
    //默认的徽章狂站距离
    private static final int DEFAULT_PADDING = 4;
    //默认徽章距离右边间距
    private static final int DEFAULT_BADGEHORIZONAL_MARGIN = 12;
    //默认徽章距离上面间距
    private static final int DEFAULT_BADGEVERTICAL_MARGIN = 10;
    //默认中间图标底部距离
